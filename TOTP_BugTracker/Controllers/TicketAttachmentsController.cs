...
namespace TOTP_BugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Created,TicketId,UserId,ImageData,ImageType")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Created,TicketId,UserId,ImageData,ImageType")] TicketAttachment ticketAttachment)
        {
