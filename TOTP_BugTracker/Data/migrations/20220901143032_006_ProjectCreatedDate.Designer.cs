...
namespace TOTP_BugTracker.data.migrations
{
    ...
    [Migration("20220901143032_006_ProjectCreatedDate")]
    partial class _006_ProjectCreatedDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TOTP_BugTracker.Models.Notification", b =>
                {
                    b.HasOne("TOTP_BugTracker.Models.NotificationType", "NotificationType")
                        .WithMany()
                    ...
                    b.HasOne("TOTP_BugTracker.Models.BTUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TOTP_BugTracker.Models.BTUser", "Sender")
                        .WithMany()
